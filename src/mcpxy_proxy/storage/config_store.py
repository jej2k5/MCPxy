"""The one persistence facade the rest of MCPxy talks to.
...
class ConfigStore:
    """Single point of truth for everything persistent in MCPxy.
            ...
            for name, value_ct, description, created_at, updated_at, last_used_at in rows:
                try:
                    ...
                    raise SecretStoreError(
                        ...
                        "Restore the original MCPXY_SECRETS_KEY or wipe the "
