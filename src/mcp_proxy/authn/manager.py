"""AuthnManager — wraps ``authy.AuthManager`` for MCPy.

This is the only module in the MCPy codebase that imports from the
...
from mcp_proxy.config import AuthyConfig
