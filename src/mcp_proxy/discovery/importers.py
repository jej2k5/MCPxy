...
server entries, and converts them into MCPy-compatible upstream dicts.
This is a read-only preview; nothing is written back to the client
config and nothing is applied to MCPy's live config until the user
